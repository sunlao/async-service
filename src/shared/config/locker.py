...
from shared.models.api import aservConfig
...
from shared.models.xform import XFormConfig
...
class Locker:
    ...
    def xform(self):
        return XFormConfig(
            Dir=getenv("XFORM_DIR"), Timeout=15, AppVersion=self._app_version()
        )
