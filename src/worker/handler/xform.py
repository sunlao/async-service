...
from worker.controller.xform import XForm as Controller
...
class XForm:
    """XForm Handler executes Controller and Logs"""
    ...
    async def _execution(self, config_job: XFormConfig, **kwargs) -> HandleExecution:
        error_flag = False
        trace_back_nfo = None
        job_event_dto = None
        config: ExecutionConfig[XFormConfig] = ExecutionConfig(
